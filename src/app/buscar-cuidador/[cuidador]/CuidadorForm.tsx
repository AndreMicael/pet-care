    ...
    return (
      <div className="max-w-2xl mx-auto">
        <div className="bg-green-50 border border-green-200 rounded-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-green-800 mb-4">Agendamento Enviado!</h2>
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">{cuidador.name}</h1>
            <p className="text-xl text-blue-600 mb-2">{cuidador.title}</p>
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Agendar Cuidado com Pet</h2>
        
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Informações do Pet */}
          <div className="border-b pb-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Informações do Pet</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          {/* Informações do Dono */}
          <div className="border-b pb-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-4">Informações do Dono</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Nome Completo *
